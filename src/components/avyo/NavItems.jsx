...
const navigation = [
  ...
  { label: 'Movimentações', icon: WalletCards, children: [
    { label: 'Transações', to: '/movimentacoes/transacoes', icon: ReceiptText },
    { label: 'Cartões', to: '/movimentacoes/cartoes', icon: CreditCard },
    { label: 'Parcelamentos', to: '/movimentacoes/parcelamentos', icon: CircleDollarSign },
    { label: 'Assinaturas', to: '/movimentacoes/assinaturas', icon: Sparkles },
  ]},
  { label: 'Planejamento', icon: Target, children: [
    { label: 'Orçamento', to: '/planejamento/orcamento', icon: BarChart3 },
  ...
  { label: 'Aprender', icon: GraduationCap, children: [
    { label: 'Escola', to: '/aprender/escola', icon: BookOpen },
    { label: 'Calculadoras', to: '/aprender/calculadoras', icon: BarChart3 },
    { label: 'Ajuda', to: '/aprender/ajuda', icon: BookOpen },
